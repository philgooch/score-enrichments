...
DATA_AVAILABILITY_PATTERN_URL = DATA_AVAILABILITY_ROOT + [
...
DATA_AVAILABILITY_PATTERN_CLOSED = DATA_AVAILABILITY_ROOT + [
...
DATA_AVAILABILITY_PATTERN_SUPPLEMENT = DATA_AVAILABILITY_ROOT + [
    {'TEXT': {"REGEX": "^(available|found|deposited|provided)$"}},
    {"ORTH": ",", "OP": "?"},
    {"ORTH": "(", "OP": "?"},
    {"IS_ALPHA": True, "OP": "?"},
